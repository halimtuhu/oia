            ...
            <form method="post" action="/kegiatan/{{$kegiatan->id}}" enctype="multipart/form-data">
              ...
              <div class="form-group ">
                ...
                <div class="input-group">
                  ...
                  <input class="form-control" id="tgl_mulai" name="tgl_mulai" placeholder="DD-MM-YYYY" type="text" value="{{date("d-m-Y", strtotime($kegiatan->tgl_mulai))}}" required="required"/>
                </div>
              </div>
              ...
              <div class="form-group ">
                ...
                <div class="input-group">
                  ...
                  <input class="form-control" id="tgl_selesai" name="tgl_selesai" placeholder="DD-MM-YYYY" type="text" value="{{date("d-m-Y", strtotime($kegiatan->tgl_selesai))}}" required="required"/>
                </div>
              </div>
                      ...
                      <table class="table">
                        <tr style="text-align: center;">
                          @foreach ($preimage as $key => $value)
                            <td><img src="/storage/{{Sentinel::getUser()->id}}/{{$kegiatan->id}}/{{$value}}" alt="{{$value}}" height="200px"></td>
                          @endforeach
                        </tr>
                        <tr style="text-align: center;">
                          @foreach ($preimage as $key => $value)
                            <td>
                              <button type="submit" class="btn btn-xs btn-danger" name="delete" formaction="/kegiatan/{{$kegiatan->uploader}}/{{$kegiatan->id}}/{{$value}}">Hapus</button>
                            </td>
                          @endforeach
                        </tr>
                      </table>
              ...
              <div class="form-group">
                <div style="text-align: center">
                  <button class="btn btn-success" name="update" type="button" onclick="location.href='/kegiatan/'">Kembali</button>
