            ...
            <form method="post" action="/kegiatan" enctype="multipart/form-data">
              ...
              <div class="form-group ">
                ...
                <div class="input-group">
                  ...
                  <input class="form-control datepicker" id="tgl_mulai" name="tgl_mulai" placeholder="MM-DD-YYYY" type="text" value="" required="required"/>
                </div>
              </div>
              ...
              <div class="form-group ">
                ...
                <div class="input-group">
                  ...
                  <input class="form-control datepicker" id="tgl_selesai" name="tgl_selesai" placeholder="MM-DD-YYYY" type="text" value="" required="required"/>
                </div>
              </div>
              ...
              <div class="form-group">
                <div style="text-align: center">
                  <button class="btn btn-success" name="back" onclick="history.go(-1);">Kembali</button>
                  <button class="btn btn-primary" name="tambah_btn" type="submit">Tambah</button>
                </div>
              </div>
            </form>
          </div>
